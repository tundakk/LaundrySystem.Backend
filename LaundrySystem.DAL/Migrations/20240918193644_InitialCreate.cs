    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DesiredTimeslots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DesiredTimeslots_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DesiredTimeslots_Timeslots_TimeslotId",
                        column: x => x.TimeslotId,
                        principalTable: "Timeslots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DesiredTimeslots_TimeslotId",
                table: "DesiredTimeslots",
                column: "TimeslotId");

            migrationBuilder.CreateIndex(
                name: "IX_DesiredTimeslots_UserId",
                table: "DesiredTimeslots",
                column: "UserId");
